...
(function(){
  ...
  document.addEventListener('DOMContentLoaded', async function(){
    ...
    form.addEventListener('submit', async function(e){
      ...
      const vetContactInput = document.querySelector('#popout-vet-contact');
      const vetSpecInput = document.querySelector('#popout-vet-spec');
      const vetLicenseInput = document.querySelector('#popout-vet-license');
      const vetExpInput = document.querySelector('#popout-vet-exp');
      const clinicBranchInput = document.querySelector('#popout-clinic-branch');
      ...
      try{
        ...
        if (res.ok && json.status === 'success'){
          Swal.fire({ title: 'Saved!', text: 'Your profile has been updated.', icon: 'success', timer: 1500, showConfirmButton: false });
